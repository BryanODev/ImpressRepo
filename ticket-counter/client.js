...
function createTicket(t) {
    return (async function () {
        try {
            ...
            // Parse the created card data from the Trello API response
            let createdCard = await response.json();
            ...
            // Optionally rethrow or return null/error depending on how you want to handle it upstream
            throw error;
        }
    })();
}
